...
st.set_page_config(page_title="Dashboard Ejecutivo de Incidentes", layout="wide")

st.title("🚦 Dashboard Ejecutivo de Incidentes Operativos")
...
if archivo:
    ...
    st.subheader("📌 Semáforos Ejecutivos")
    ...
    c3.markdown(
        ...
        f"{sem_est} <b>Máx Incidentes por Estación</b><br><h2>{top_estacion}</h2></div>",
        unsafe_allow_html=True
    )
    ...
    st.info("⬆️ Carga un archivo Excel para activar el dashboard")
